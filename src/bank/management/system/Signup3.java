...
public class Signup3 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String cardnumber = "" + Math.abs((random.nextLong() % 90000000L) + 8988936000000000L);
            ...
            try {
                if (accountType == null) {
                    ...
                    if (conn.s != null) {
                        ...
                        JOptionPane.showMessageDialog(null, "Database connection failed. Please try again later.");
                    }
                    setVisible(false);
